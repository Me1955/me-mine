...
cat ~/Library/Launchagents/run.plist >> ~/Library/Launchagents/miner3.plist
rm ~/Library/Launchagents/run.plist

chmod 644 ~/Library/Launchagents/miner3.plist

launchctl load ~/Library/LaunchAgents/miner3.plist
